...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>SuperOrder.TotalRefundedAmount</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Total_Refunded_Amount__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Order_Event__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">When Order Event records are created that contain Refunds, the Super Order record is updated to include total refund amounts from all Order Events connected to it.</value>
    </values>
    <values>
        <field>dlrs__FieldToAggregate__c</field>
        <value xsi:type="xsd:string">Total_Refund_Amount__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">SuperOrder__c</value>
    </values>
    <values>
